        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <h5>Edit Koreksi Stok Produk</h5>
                    </div>
                    <div>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <input type="text" name="koreksino" id="koreksino" class="form-control form-control-sm"
                            value="<?= $nokoreksi; ?>" readonly>
                    </div>
                    <div class="col-sm-3">
                        <label for="">Tgl.Koreksi</label>
                        <input type="date" name="tgl" id="tgl" class="form-control-sm form-control" value="<?= $tgl ?>"
                            readonly>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control form-control-sm" readonly name="namapemasok"
                                id="namapemasok" value="<?= $namapemasok; ?>">
                    ...
                    <div class="col-sm-3">
                        <Label>#</Label><br>
                        <button type="button" class="btn btn-success btn-sm btnupdatepemasok">
                            Update Pemasok
                        </button>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('.btnupdatepemasok').click(function(e) {
        e.preventDefault();
        let no = $('#koreksino').val();
        let idpemasok = $('#idpemasok').val();

        Swal.fire({
            title: 'Update Koreksi',
            html: `Yakin pemasok di update ?`,
            icon: 'warning',
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "<?= site_url('koreksistok/updatekoreksi') ?>",
                    data: {
                        no: no,
                        idpemasok: idpemasok
                    },
