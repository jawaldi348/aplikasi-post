...
<div class="col-lg-12">
    <div class="card m-b-30">
        <?= form_open('admin/satuan/delete_multi', ['class' => 'formdelete']); ?>
        ...
        <div class="card-body">
            ...
            <table class="table table-sm table-striped table-bordered display nowrap" id="datasatuan" width="100%">
                <thead>
                    <tr>
                        <th>
...
<script src="<?= base_url(); ?>assets/novinaldi/satuan.js"></script>