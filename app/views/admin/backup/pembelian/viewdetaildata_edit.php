...
<div class="col-lg-12">
    <div class="card m-b-30">
        <h4 class="card-header mt-0"> <button type="button" class="btn btn-sm btn-round btn-outline-primary"><i
            ...
            Pembelian</h4>
        <div class="card-body">
            <?= form_open('admin/pembelian/selesaitransaksi', ['class' => 'formselesaitransaksilagi']) ?>
                ...
                <table class="table table-striped">
                        ...
                        <tr>
                            <td>
                                <button type="button" class="btn btn-sm btn-outline-danger"
                                    onclick="hapusitem('<?= $d['detid'] ?>')" data-toggle="tooltip" data-placement="top"
                                    data-original-title="Hapus Item">
                                    <i class="fa fa-trash-alt"></i>
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-info"
                                    onclick="edititem('<?= $d['detid'] ?>')" data-toggle="tooltip" data-placement="top"
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="pph" value="<?= $pph ?>" id="pph" class="form-control"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="dispersen" value="<?= $diskonpersen ?>" id="dispersen"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="disrp" value="<?= $diskonuang ?>" id="disrp"
                                    class="form-control" data-toggle="tooltip" data-placement="top"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="totalpembayaran" id="totalpembayaran"
                                    value="<?= number_format($totalbersih, 2, ",", "."); ?>"
            ...
            <div class="row justify-content-end">
                <div class="col-sm-3">
                    ...
                    <select name="jenispembayaran" id="jenispembayaran" class="form-control">
                        <option value="T" <?php if ($jenisbayar == 'T') echo 'selected'; ?>>Tunai</option>
                        <option value="K" <?php if ($jenisbayar == 'K') echo 'selected'; ?>>Kredit</option>
                    </select>
                </div>
                <div class="col-sm-2">
...
<div style="display: none;" class="viewmodalitem"></div>
<script>
$(document).on('submit', '.formselesaitransaksilagi', function(e) {
    Swal.fire({
...
function hapusitem(id) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                type: "post",
                url: "<?= site_url('admin/pembelian/hapusitem') ?>",
                data: {
                    id: id
                },
                dataType: "json",
...
function edititem(id) {
    $.ajax({
        type: "post",
        url: "<?= site_url('admin/pembelian/edititem') ?>",
        data: {
            id: id
        },
        success: function(response) {
            $('.viewmodalitem').html(response).show();
