...
<script>
    ...
    $(document).on('click', '.create', function() {
        $.post(BASE_URL + 'group-user/create', function(resp) {
            $('#tampil-modal').show();
    ...
    $(document).on('click', '.destroy', function() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.post(BASE_URL + 'group-user/destroy', {
                    'id': id
                }, function(response) {
